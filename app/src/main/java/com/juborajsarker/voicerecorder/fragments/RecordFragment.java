...
import com.juborajsarker.voicerecorder.simple_class.RecordingService;
...
public class RecordFragment extends Fragment {
    ...
    private void onRecord(boolean start){
        ...
        if (start) {
            ...
            mPauseButton.setVisibility(View.VISIBLE);
            mPauseButton.setBackgroundColor(Color.parseColor("#FFC107"));
            File folder = new File(Environment.getExternalStorageDirectory() + "/SimpleAudioRecorder");
            if (!folder.exists()) {
                //folder /SimpleAudioRecorder doesn't exist, create the folder
                folder.mkdir();
            }
