package com.juborajsarker.voicerecorder.fragments;
...
import com.juborajsarker.voicerecorder.BuildConfig;
import com.juborajsarker.voicerecorder.simple_class.MySharedPreferences;
import com.juborajsarker.voicerecorder.R;
import com.juborajsarker.voicerecorder.activities.SettingsActivity;
...
public class SettingsFragment extends PreferenceFragment {
    ...
    public void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        CheckBoxPreference highQualityPref = (CheckBoxPreference)
                findPreference(getResources().getString(R.string.pref_high_quality_key));
